                ...
                <section className="min-h-[85vh] flex flex-col lg:flex-row items-center justify-between gap-16 py-12">
                    <div className="w-full lg:w-1/2 z-10 reveal">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            <a href="https://release-assets.githubusercontent.com/github-production-release-asset/1258720471/c867a151-b288-4b78-b4df-a29c334fe6c1?sp=r&sv=2018-11-09&sr=b&spr=https&se=2026-06-16T12%3A42%3A47Z&rscd=attachment%3B+filename%3Dlostandfound.V1.1.apk&rsct=application%2Fvnd.android.package-archive&skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&sktid=398a6654-997b-47e9-b12b-9515b896b4de&skt=2026-06-16T11%3A42%3A22Z&ske=2026-06-16T12%3A42%3A47Z&sks=b&skv=2018-11-09&sig=XXs%2BtOPbXuuE7U7AlLMRG8Vjcd1VMEJmjnt79Y00XEA%3D&jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc4MTYxMTk0MiwibmJmIjoxNzgxNjEwMTQyLCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.B1I77LOjzobsZMYAx-6TEZHjvxSQvnnnVr0vmSLGcOM&response-content-disposition=attachment%3B%20filename%3Dlostandfound.V1.1.apk&response-content-type=application%2Fvnd.android.package-archive" className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white font-bold text-lg shadow-[0_0_30px_rgba(168,85,247,0.4)] hover:shadow-[0_0_50px_rgba(168,85,247,0.6)] hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden">
